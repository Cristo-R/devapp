...
func init() {
	Migrations = append(Migrations, &gormigrate.Migration{
		ID: "20211123_create_app_screenshots",
		Migrate: func(tx *gorm.DB) error {
			type ApplicationScreenshot struct {
				...
				ApplicationLocaleId string    `gorm:"type:varbinary(16);not null;index:idx_application_screenshots_on_application_locale_id" json:"application_locale_id"`
			}
			return tx.Debug().Set("gorm:table_options", "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4").
				AutoMigrate(&ApplicationScreenshot{}).
				Error
		},
