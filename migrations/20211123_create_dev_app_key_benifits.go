...
func init() {
	Migrations = append(Migrations, &gormigrate.Migration{
		ID: "20211123_create_dev_app_key_benefits",
		Migrate: func(tx *gorm.DB) error {
			type DevApplicationKeyBenefit struct {
				...
				DevApplicationLocaleId string    `gorm:"type:bigint(20);not null;index:idx_dev_application_key_benefits_on_dev_application_locale_id" json:"dev_application_locale_id"`
			}
			return tx.Debug().Set("gorm:table_options", "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4").
				AutoMigrate(&DevApplicationKeyBenefit{}).
				Error
		},
